...
### 1. Aufgabe schnappen
1. Geh auf unser [GitHub Project Board](LINK_ZU_EUREM_BOARD_HIER_EINfügen).
...
* [z.B. Node.js (Version X) oder Python 3.10]
* [z.B. Docker]
...
1. **Repository klonen:**
   ```bash
   git clone [https://github.com/dein-username/dein-projekt.git](https://github.com/dein-username/dein-projekt.git)
